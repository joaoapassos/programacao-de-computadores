...
public class Exercicio_1 {
    ...
    public static void main(String[] args) {
        ...
        switch(diaDaSemana){
            case 0 -> JOptionPane.showMessageDialog(null, "Dia da semana é Domingo");
            case 1 -> JOptionPane.showMessageDialog(null, "Dia da semana é Segunda");
            case 2 -> JOptionPane.showMessageDialog(null, "Dia da semana é Terça");
            case 3 -> JOptionPane.showMessageDialog(null, "Dia da semana é Quarta");
            case 4 -> JOptionPane.showMessageDialog(null, "Dia da semana é Quinta");
            case 5 -> JOptionPane.showMessageDialog(null, "Dia da semana é Sexta");
            case 6 -> JOptionPane.showMessageDialog(null, "Dia da semana é Sabado");
